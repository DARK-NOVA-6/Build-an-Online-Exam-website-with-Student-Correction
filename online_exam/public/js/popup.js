function buildPopup(isConifrm, onConfirm = doNothing, isFake = false,onCancel = doNothing(),cancelBText='cancel') {
    newId = $(document).data('popId');
    newId++;
    $(document).data('popId', newId);
    $('<div/>', {
            id: 'popup' + newId,
